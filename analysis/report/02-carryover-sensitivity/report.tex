...
\renewcommand{\stamptime}{2026-07-30 18:29 PDT}
\renewcommand{\stampversion}{\detokenize{0ccf0ef-wip}}
\usepackage{amssymb}
\usepackage{booktabs}
...
\texttt{02-sensitivity-summary.rds} under \texttt{analysis/data/}. Everything used
...
\texttt{02-carryover-replicates.rds} (per-replicate) and
\texttt{02-carryover-summary.txt} (Morris ADEMP cell-level summary), under
\texttt{analysis/data/quick-sim/}. The manuscript source, its bibliography
(\texttt{references.bib}), and the SIM CSL file are in this paper's own
directory under \texttt{analysis/report/}. Superseded wider-scope drafts
are retained there under \texttt{archive/} and are documented in its
\texttt{README.md}.
