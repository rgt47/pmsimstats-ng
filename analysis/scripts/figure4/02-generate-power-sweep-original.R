...
# bundled results_core.rda and the published Figure 4 in Hendrickson
# et al. (2020).
#
# The current R/ code has been modified since the initial commit
# (Ron Thomas edits, autocorrelation typo fix, carryover changes).
# This script sources the original versions from
# analysis/scripts/original_R/ to produce results consistent with
# the publication.
#
# Usage:
#   Rscript analysis/scripts/figure4/02-generate-power-sweep-original.R
#   NREPS=50 Rscript analysis/scripts/figure4/02-generate-power-sweep-original.R
...
cat("Using ORIGINAL code from initial commit (42ac030)\n\n")
...
save_basename <- paste0("results_core_orig_", timestamp)
