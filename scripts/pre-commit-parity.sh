...
# that has been annotated in analysis/scripts/parity/parity_divergences.csv):
...
if Rscript analysis/scripts/parity/test-parity-extended-tidyverse.R --quick; then
  ...
  echo "  analysis/scripts/parity/parity_divergences.csv" >&2
