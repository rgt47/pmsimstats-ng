...
developed notably by Rothwell (2005) and synthesized more
recently by Kent et al. (2020), distinguishes between
...
scales the treatment effect. Simon (2010) employs this approach
throughout the simulation frameworks he develops for
biomarker-stratified designs; Freidlin and Korn (2014) adopt
it for adaptive enrichment trials; Renfro and Sargent (2017)
...
of Hendrickson et al. (2020) is not a convention of any
...
the effect modeling equation of Kent et al. (2020):
...
et al. (2013), whose SBP-stratified secondary analysis is the
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item Earlier single-site Raskind trials (2003, 2007, 2013)
  reported benefit on nightmares and PTSD symptoms.
...
The earlier single-site trials by Raskind and colleagues (2003,
...
ADEMP template of Morris, White, and Crowther (2019), which
...
\begin{orig}
The statistical literature on treatment effect heterogeneity
is extensive. Rothwell (2005) sets out the foundational
...
Statement of Kent et al. (2020), which distinguishes two
...
standard. Simon (2010) employs it throughout the simulation
frameworks he develops for biomarker-stratified designs;
Freidlin and Korn (2014) adopt it for adaptive enrichment
trials; Renfro and Sargent (2017) use it for basket and
umbrella trials; and it underlies the platform trial literature
throughout. Haller and Ulm (2018), in simulation work on
...
(1997), Araujo et al. (2016), and Duan et al. (2013), use
...
correlation and carryover, from both Wang and Schork (2019) and
Schork (2022), adopts the same Architecture A specification,
...
Rizopoulos (2012), Bayesian joint modeling frameworks, and
...
Senn (2002) and Jones and Kenward (2014), addresses carryover
extensively but does not distinguish between architectures for
biomarker-treatment interaction modeling. More recent
methodological work by Sturdevant and Lumley (2021) on testing
...
Simon (2010) and Freidlin and Korn (2014), use Architecture A
...
Sargent (2017), introduce an additional layer because their
