...
\pagestyle{fancy}
\fancyhf{}
\rhead{Covariance Matrix Positive Definiteness}
\lhead{pmsimstats White Paper}
\rfoot{\thepage}

\title{Positive Definiteness Failures in the\\
       pmsimstats Covariance Matrix:\\
       Prevalence, Causes, and Consequences\\[6pt]
       \large White Paper on Structural Constraints in the
       Hendrickson et al.\ (2020) Data-Generating Process}
\author{Automated analysis of the \texttt{pmsimstats} codebase}
\date{2026-03-19}
...
simulation pipeline to measure the frequency and severity of
these failures across four code versions (commits). The results
...
We instrumented the simulation by replacing
...
We tested four commits spanning the repository history:
...
{\footnotesize Rendered on 2026-03-19.}\\
\noindent Source: \textasciitilde/prj/alz/01c-pmsimstats-orig/%
pmsimstats/analysis/output/pd\_failure\_white\_paper.tex}}
