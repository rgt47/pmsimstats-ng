...
\renewcommand{\stamptime}{2026-09-02 11:31 PDT}
\renewcommand{\stampversion}{\detokenize{a799b39-wip}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
\usepackage{array}
...
neurology\textsuperscript{\citeproc{ref-stunnenberg2022}{4}},
epilepsy care\textsuperscript{\citeproc{ref-margolis2019}{5}}, palliative care\textsuperscript{\citeproc{ref-nikles2011}{6}},
translational nutrition\textsuperscript{\citeproc{ref-schork2017nutrition}{7}}, and the single-case
experimental designs of psychology and education\textsuperscript{\citeproc{ref-smith2012}{8}}, and a
scoping review now assesses the effect of the design on clinical
outcomes themselves\textsuperscript{\citeproc{ref-samuel2022}{9}}. The design has acquired both a
CONSORT reporting extension and a national policy agenda\textsuperscript{\citeproc{ref-vohra2016cent}{10},\citeproc{ref-davidson2018nam}{11}}. The principal advantage of these
...
sample sizes far below those a parallel-group trial would require\textsuperscript{\citeproc{ref-zucker1997}{12}--\citeproc{ref-senn2016mastering}{14}}. This efficiency gain
...
serial correlation that repeated within-participant measurement induces\textsuperscript{\citeproc{ref-senn2019samplesize}{17}--\citeproc{ref-tueller2022}{20}}.
...
is, whether a baseline marker identifies which participants respond\textsuperscript{\citeproc{ref-kent2020path}{21}--\citeproc{ref-haller2018}{24}}. The repeated
...
validation\textsuperscript{\citeproc{ref-hendrickson2020}{25}--\citeproc{ref-schork2023precision}{27}}.
...
it\textsuperscript{\citeproc{ref-simon2010}{22},\citeproc{ref-freidlin2014}{23}}. The second, covariance
moderation through differential correlation, used by Hendrickson
et al.\textsuperscript{\citeproc{ref-hendrickson2020}{25}} for N-of-1 trials, instead makes the
...
responder-class mechanism, developed at length in a companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper03}{29}}. Patients may belong to unobserved responder
...
treatment, it is developed in a companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper11}{30}} and is not considered further here.
...
Hendrickson et al.\textsuperscript{\citeproc{ref-hendrickson2020}{25}} chose covariance moderation
...
correlation\textsuperscript{\citeproc{ref-grenet2020}{31}}. That result is derived for a two-period
...
within each participant\textsuperscript{\citeproc{ref-senn2016mastering}{14},\citeproc{ref-senn2019samplesize}{17},\citeproc{ref-senn2011individual}{32}}, which none of the designs studied here provides.
...
residual heterogeneity is developed in a companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper03}{29}}.
...
of Kent et al.\textsuperscript{\citeproc{ref-kent2020path}{21}},
...
companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper03}{29}} develops the mixture and
...
cataloguing where it fails. Senn\textsuperscript{\citeproc{ref-senn2016mastering}{14}} also cautions
...
channel, the dual-channel architecture of the companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper11}{30}} is the appropriate model, and because it
...
literature. The PATH framework of Kent et al.\textsuperscript{\citeproc{ref-kent2020path}{21}}
...
is available in the companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper11}{30}}.
...
Simon\textsuperscript{\citeproc{ref-simon2010}{22}}, Freidlin and Korn\textsuperscript{\citeproc{ref-freidlin2014}{23}}, Renfro and Sargent\textsuperscript{\citeproc{ref-renfro2017}{41}}, and standard N-of-1 simulation studies all put the
biomarker effect in the mean. Even methodological work on N-of-1
carryover sharing authors with Hendrickson et al.\textsuperscript{\citeproc{ref-hendrickson2020}{25}}
...
by, the analysis-model guidance in the PATH statement\textsuperscript{\citeproc{ref-kent2020path}{21}}. The architecture choice matters most in exactly
...
is characterized in a companion calibration study\textsuperscript{\citeproc{ref-pmsimstats-paper10}{36}}. Nominal coverage was inferred from the
...
entirely to a companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper11}{30}}, and our
...
architecture developed in a companion paper\textsuperscript{\citeproc{ref-pmsimstats-paper11}{30}} the third. Within the Gaussian family there is
