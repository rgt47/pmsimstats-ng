...
\renewcommand{\stampversion}{\detokenize{53dfeaa-wip}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
...
variance in treatment response\textsuperscript{\citeproc{ref-lillie2011}{1},\citeproc{ref-nam2021expanding}{2}}.
...
precision-medicine therapeutic decision-making\textsuperscript{\citeproc{ref-kravitzSinglepatientNof1Trials2014}{3},\citeproc{ref-marshallScopingReviewRandomized2022}{4}}.
...
crossover periods\textsuperscript{\citeproc{ref-Miller1999n}{5},\citeproc{ref-vohraCONSORTExtensionReporting2015}{6}}.
...
providing individual-level treatment-effect estimates\textsuperscript{\citeproc{ref-zucker2010}{7},\citeproc{ref-schmidBayesianModelsNof12021}{8}}. When appropriately aggregated across
patients, N-of-1 trials can support population-level inference while
simultaneously informing individual treatment decisions\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9},\citeproc{ref-araujoComparisonFourMethods2014}{10}}.
...
treatment decisions\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9},\citeproc{ref-araujoComparisonFourMethods2014}{10}}.
...
parallel-group designs\textsuperscript{\citeproc{ref-schmidStatisticalDesignAnalytic2014}{11},\citeproc{ref-sennAnalysisContinuousData2024}{12}}. We note that among the key
considerations are the appropriate handling of carryover effects,
period effects, and temporal trends within individual patients\textsuperscript{\citeproc{ref-tangTtestsNof1Trials2020}{13},\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}}.
...
within-patient and between-patient variability\textsuperscript{\citeproc{ref-zucker2010}{7}}.
...
estimates while incorporating heterogeneity between patients\textsuperscript{\citeproc{ref-chenMethodologicalReviewRandomised2024}{17}}.
...
variability\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}. Simulation studies
...
individual variability is substantial\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}}. But how large is the
...
scenarios\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}}. Understanding
...
magnitude of within-patient relative to between-patient variability\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}. Simulation studies have suggested
...
effects are moderately large and individual variability is substantial\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}}. But how large is the
...
varying effect sizes and carryover scenarios\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}}, and understanding these
...
residual measurement error\textsuperscript{\citeproc{ref-schmidStatisticalDesignAnalytic2014}{11},\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
measurement error\textsuperscript{\citeproc{ref-schmidStatisticalDesignAnalytic2014}{11},\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
\begin{rgt}
Senn\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}} formalized the sample size
...
within-patient, within-cycle variance of the paired differences\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}. The factor of 2 arises because
...
reduces the entire expression proportionally\textsuperscript{\citeproc{ref-zucker2010}{7},\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
\(n\) reduces the entire expression proportionally\textsuperscript{\citeproc{ref-zucker2010}{7},\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
\begin{rgt}
Senn\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}} distinguished two
inferential goals with distinct power formulas. For a \emph{random-effects}
...
\begin{orig}
Senn\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}} distinguished two inferential
...
\begin{rgt}
For a \emph{fixed-effects} analysis, appropriate when the inferential goal
...
and \(n(k-1)\) degrees of freedom\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
\begin{rgt}
Zucker et al.\textsuperscript{\citeproc{ref-zucker2010}{7}} studied the trade-off between the number
...
\begin{rgt}
Senn\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}} further extended these
...
ways not captured by balanced-design formulas\textsuperscript{\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}}.
...
power estimates\textsuperscript{\citeproc{ref-tangTtestsNof1Trials2020}{13}}. Wang and Schork\textsuperscript{\citeproc{ref-wang2019}{19}} demonstrated, via likelihood-ratio methods under an
...
estimates\textsuperscript{\citeproc{ref-tangTtestsNof1Trials2020}{13}}. Wang and Schork\textsuperscript{\citeproc{ref-wang2019}{19}} demonstrated via likelihood-ratio methods
...
be jointly optimized\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
and the population estimate must be jointly optimized\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
behavioral and educational research\textsuperscript{\citeproc{ref-kratochwillSinglecaseExperimentalDesigns2013}{20},\citeproc{ref-ledfordSinglecaseDesignAnalysis2018}{21}}. The methodological rigor of
SCEDs has evolved to include analytical approaches that can provide
valid causal inferences from individual-level data\textsuperscript{\citeproc{ref-americanspeech-language-hearingassociationSinglesubjectExperimentalDesign2014}{22},\citeproc{ref-michielsMultiSCEDToolMetaanalyzing2020}{23}}.
...
appropriate statistical analysis\textsuperscript{\citeproc{ref-mitchellDevelopmentSetKey2024}{24}}.
These advances have strengthened the evidence base for using N-of-1
trials as a complement to traditional group-based designs\textsuperscript{\citeproc{ref-mcdonaldMakingSwitchCase2019}{25}}.
...
statistical analysis\textsuperscript{\citeproc{ref-mitchellDevelopmentSetKey2024}{24}}. These advances
have strengthened the evidence base for using N-of-1 trials as a
complement to traditional group-based designs\textsuperscript{\citeproc{ref-mcdonaldMakingSwitchCase2019}{25}}.
...
the chronic, fluctuating nature of symptoms\textsuperscript{\citeproc{ref-raskind2003}{26}}. Prazosin,
an \(\alpha_1\)-adrenergic receptor antagonist, has demonstrated
efficacy for reducing trauma-related nightmares in multiple RCTs\textsuperscript{\citeproc{ref-raskind2013}{27},\citeproc{ref-raskind2018}{28}}, though individual response patterns
vary considerably.
...
chronic, fluctuating nature of symptoms\textsuperscript{\citeproc{ref-raskind2003}{26}}. Prazosin, an
\(\alpha_1\)-adrenergic receptor antagonist, has demonstrated efficacy
for reducing trauma-related nightmares in multiple RCTs\textsuperscript{\citeproc{ref-raskind2013}{27},\citeproc{ref-raskind2018}{28}}, though
...
effects\textsuperscript{\citeproc{ref-Khazaie2016Prazosin}{29},\citeproc{ref-mayerRandomizedControlledPilot2023}{30}}.
Previous studies have documented both the efficacy and the individual
variability of prazosin response\textsuperscript{\citeproc{ref-Raskind2007Placebo}{31},\citeproc{ref-Raskind2009Placebo}{32}}, and these studies provide an empirical
...
while also necessitating careful consideration of carryover effects\textsuperscript{\citeproc{ref-Khazaie2016Prazosin}{29},\citeproc{ref-mayerRandomizedControlledPilot2023}{30}}. Previous
studies have documented both the efficacy and the individual variability
of prazosin response\textsuperscript{\citeproc{ref-Raskind2007Placebo}{31},\citeproc{ref-Raskind2009Placebo}{32}},
...
\begin{rgt}
The increasing recognition of N-of-1 trials by regulatory agencies\textsuperscript{\citeproc{ref-fda2021clinical}{33}} and research institutions\textsuperscript{\citeproc{ref-nam2021expanding}{2}} has
...
implementation\textsuperscript{\citeproc{ref-vohraCONSORTExtensionReporting2015}{6},\citeproc{ref-kravitzIntroductionNof1Trials2014}{34}}, and specialized software tools
have emerged to support N-of-1 trial analysis\textsuperscript{\citeproc{ref-michielsMultiSCEDToolMetaanalyzing2020}{23},\citeproc{ref-hussey2020sced}{35}}.
...
statistical frameworks. Professional organizations have developed
comprehensive recommendations for N-of-1 trial design and
implementation\textsuperscript{\citeproc{ref-vohraCONSORTExtensionReporting2015}{6},\citeproc{ref-kravitzIntroductionNof1Trials2014}{34}}, while specialized software tools
have emerged to support N-of-1 trial analysis\textsuperscript{\citeproc{ref-michielsMultiSCEDToolMetaanalyzing2020}{23},\citeproc{ref-hussey2020sced}{35}}.
...
crossover RCTs\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}}. Using 5,000
...
study of aggregated N-of-1 trials versus parallel and crossover RCTs\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}}. Using 5,000 simulated trials
...
\begin{rgt}
A more recent comparison by Carrozzo and colleagues\textsuperscript{\citeproc{ref-carrozzoTwoArm2025}{36}} examined a two-arm parallel RCT, a two-period
...
predictive-biomarker validation\textsuperscript{\citeproc{ref-hendricksonOptimizing2020}{37}}. That
...
\begin{rgt}
Wang and Schork\textsuperscript{\citeproc{ref-wang2019}{19}} extended the analytical and simulation
...
\begin{orig}
Wang and Schork\textsuperscript{\citeproc{ref-wang2019}{19}} extended the analytical
...
\begin{rgt}
Gaertner and colleagues\textsuperscript{\citeproc{ref-gaertnerCarryover2023}{38}} simulated aggregated
...
corresponding closed-form solutions\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}. The decomposition
...
expression proportionally. Zucker, Ruthazer, and Schmid\textsuperscript{\citeproc{ref-zucker2010}{7}}
...
Senn formalized sample-size planning for sets of N-of-1 trials under a
Normal-Normal mixture model and identified five planning criteria with
corresponding closed-form solutions\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{18}}.
...
colleagues\textsuperscript{\citeproc{ref-jiangDesignAnalysis2025}{39}} proposed sequential monitoring
...
application. Selukar, Prince, and May\textsuperscript{\citeproc{ref-selukarFrameworkSequential2025}{40}}
...
alpha-spending corrections. Giai and colleagues\textsuperscript{\citeproc{ref-giaiIndividualizedNet2023}{41}} evaluated generalized pairwise comparison
...
alpha-spending corrections. Giai and colleagues\textsuperscript{\citeproc{ref-giaiIndividualizedNet2023}{41}}
...
\begin{rgt}
We follow the ADEMP framework of Morris, White, and Crowther\textsuperscript{\citeproc{ref-morris2019simulation}{42}}: Aims, Data-generating mechanisms, Estimands,
...
\begin{orig}
We follow the ADEMP framework of Morris, White, and Crowther\textsuperscript{\citeproc{ref-morris2019simulation}{42}}: Aims, Data-generating mechanisms,
...
parallel-group comparator. The \textbf{primary inferential output} is the
...
following the paired-comparison discipline of Morris et al.\textsuperscript{\citeproc{ref-morris2019simulation}{42(sec5.4)}}. Each replicate begins by drawing \(N =
...
\begin{orig}
Both arms operate on the same patient pool within each replicate,
following the paired-comparison discipline of Morris et al.\textsuperscript{\citeproc{ref-morris2019simulation}{42(sec5.4)}}. Each replicate begins by
...
\textbf{Units.} We quote carryover half-lives \(t_{1/2}\) in \textbf{days}
...
\begin{rgt}
\textbf{N-of-1 arm.} We analyze each replicate with the linear mixed-effects
model
...
\begin{rgt}
We follow the random-number discipline of Morris et al.\textsuperscript{\citeproc{ref-morris2019simulation}{42(sec4.6)}}.
...
\begin{orig}
Random-number discipline follows Morris et al.\textsuperscript{\citeproc{ref-morris2019simulation}{42(sec4.6)}}.
\texttt{RNGkind("L'Ecuyer-CMRG")} is set once at program entry, followed
...
100.0\% (MCSE
0.0 pp)
for the aggregated N-of-1 hybrid. Under the Morris\textsuperscript{\citeproc{ref-morris2019simulation}{42(sec5.4)}} paired design, the within-replicate
power difference was 0.325 (paired
MCSE 0.0105). We note that the
...
100.0\% (MCSE
0.0 pp)
for the aggregated N-of-1 hybrid. Under the Morris\textsuperscript{\citeproc{ref-morris2019simulation}{42(sec5.4)}} paired design, the
...
0\%, 95\% CI:
100--100\%),
compared with 67.6\% (MCSE =
1\%) for the parallel-group RCT. That
is, a difference of
...
where between-patient variability is expected to be substantial\textsuperscript{\citeproc{ref-lillie2011}{1},\citeproc{ref-nam2021expanding}{2}}.
...
baseline differences are large relative to measurement error\textsuperscript{\citeproc{ref-patsopoulosUnderstandingControlledTrials2011}{16}}. Our findings extend
previous theoretical and simulation work\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}} by providing empirical power
...
recruitment for a clinical trial is otherwise difficult\textsuperscript{\citeproc{ref-ncbi2012small}{43}}.
...
otherwise difficult\textsuperscript{\citeproc{ref-ncbi2012small}{43}}.
...
and statistical power in N-of-1 trials\textsuperscript{\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}}. Intuition might suggest that any
...
there is substantial individual variation in treatment response\textsuperscript{\citeproc{ref-raskind2018}{28}}; the relatively short pharmacokinetic half-life of
prazosin facilitates crossover designs\textsuperscript{\citeproc{ref-Khazaie2016Prazosin}{29}}; and
nightmare frequency is a continuous outcome suitable for repeated
assessment\textsuperscript{\citeproc{ref-mayerRandomizedControlledPilot2023}{30}}.
...
The clinical scenario of prazosin for PTSD nightmares provides a
well-suited test case for N-of-1 methodology for several reasons:
there is substantial individual variation in treatment response\textsuperscript{\citeproc{ref-raskind2018}{28}}; the relatively short
pharmacokinetic half-life of prazosin facilitates crossover designs\textsuperscript{\citeproc{ref-Khazaie2016Prazosin}{29}}; and nightmare frequency is a continuous outcome
suitable for repeated assessment\textsuperscript{\citeproc{ref-mayerRandomizedControlledPilot2023}{30}}.
...
large, and carryover effects are manageable\textsuperscript{\citeproc{ref-mitchellDevelopmentSetKey2024}{24},\citeproc{ref-kravitzIntroductionNof1Trials2014}{34}}.
...
to large, and carryover effects are manageable\textsuperscript{\citeproc{ref-mitchellDevelopmentSetKey2024}{24},\citeproc{ref-kravitzIntroductionNof1Trials2014}{34}}.
...
have strengthened the evidence base for N-of-1 trials\textsuperscript{\citeproc{ref-kratochwillSinglecaseExperimentalDesigns2013}{20},\citeproc{ref-michielsMultiSCEDToolMetaanalyzing2020}{23}}. The availability of
specialized software tools\textsuperscript{\citeproc{ref-hussey2020sced}{35}} and standardized
reporting guidelines\textsuperscript{\citeproc{ref-vohraCONSORTExtensionReporting2015}{6}} has reduced
...
Recent methodological developments in single-case experimental design
have strengthened the evidence base for N-of-1 trials\textsuperscript{\citeproc{ref-kratochwillSinglecaseExperimentalDesigns2013}{20},\citeproc{ref-michielsMultiSCEDToolMetaanalyzing2020}{23}}. The availability of
specialized software tools\textsuperscript{\citeproc{ref-hussey2020sced}{35}} and standardized reporting
...
\begin{rgt}
The integration of Bayesian approaches\textsuperscript{\citeproc{ref-schmidBayesianModelsNof12021}{8}} and adaptive design elements\textsuperscript{\citeproc{ref-dazaCausalAnalysisSelftracked2018}{44}} represents a promising direction
...
characteristics\textsuperscript{\citeproc{ref-lillie2011}{1},\citeproc{ref-nam2021expanding}{2}}. N-of-1 trials
...
support both regulatory approval and clinical decision-making\textsuperscript{\citeproc{ref-mitchellDevelopmentSetKey2024}{24}}.
...
regulatory approval and clinical decision-making\textsuperscript{\citeproc{ref-mitchellDevelopmentSetKey2024}{24}}.
...
endpoints\textsuperscript{\citeproc{ref-ledfordSinglecaseDesignAnalysis2018}{21}}. Real clinical trials
...
did not consider potential differential effects on multiple endpoints\textsuperscript{\citeproc{ref-ledfordSinglecaseDesignAnalysis2018}{21}}. Real clinical trials often
...
effects might require modeling approaches not examined here\textsuperscript{\citeproc{ref-dazaCausalAnalysisSelftracked2018}{44}}.
...
require modeling approaches not examined here\textsuperscript{\citeproc{ref-dazaCausalAnalysisSelftracked2018}{44}}.
...
where the design targets differ. Comparisons with Shi and Ye\textsuperscript{\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}} (behavioral carryover) and
Tueller et al.\textsuperscript{\citeproc{ref-pequignatIdiographicPower2023}{45}} (idiographic power)
...
design targets differ. Comparisons with Shi and Ye\textsuperscript{\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}} (behavioral carryover) and Tueller
et al.\textsuperscript{\citeproc{ref-pequignatIdiographicPower2023}{45}} (idiographic power) are
...
\begin{rgt}
Blackston and colleagues\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{9}}
...
\begin{rgt}
Unfortunately, two comparisons remain incomplete: Shi and Ye\textsuperscript{\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}} on behavioral carryover in
2-period crossovers, and Tueller and colleagues\textsuperscript{\citeproc{ref-pequignatIdiographicPower2023}{45}} on idiographic power for
...
further improve efficiency\textsuperscript{\citeproc{ref-schmidBayesianModelsNof12021}{8}}. Bayesian
...
limitations\textsuperscript{\citeproc{ref-mcdonaldMakingSwitchCase2019}{25}}.
...
of both approaches while mitigating their respective limitations\textsuperscript{\citeproc{ref-mcdonaldMakingSwitchCase2019}{25}}.
...
successful implementation\textsuperscript{\citeproc{ref-mitchellDevelopmentSetKey2024}{24}}. Factors
...
\CSLLeftMargin{3. }%
\CSLRightInline{Duan N, Kravitz RL, Schmid CH. Single-patient (n-of-1) trials: A pragmatic clinical decision methodology for patient-centered comparative effectiveness research. \emph{Journal of Clinical Epidemiology}. 2013;66(8):S21-S28. doi:\href{https://doi.org/10.1016/j.jclinepi.2013.04.006}{10.1016/j.jclinepi.2013.04.006}}
...
\CSLLeftMargin{8. }%
\CSLRightInline{Schmid CH, Yang J. Bayesian models for {N}-of-1 trials. \emph{Harvard Data Science Review}. 2022;(SI3). doi:\href{https://doi.org/10.1162/99608f92.3f1772ce}{10.1162/99608f92.3f1772ce}}
...
\CSLLeftMargin{15. }%
\CSLRightInline{Lim CY, In J. Considerations for crossover design in clinical study. \emph{Korean Journal of Anesthesiology}. 2021;74(4):293-299. doi:\href{https://doi.org/10.4097/kja.21165}{10.4097/kja.21165}}

\bibitem[\citeproctext]{ref-patsopoulosUnderstandingControlledTrials2011}
\CSLLeftMargin{16. }%
\CSLRightInline{Sibbald B, Roberts C. Understanding controlled trials: Crossover trials. \emph{BMJ}. 1998;316(7146):1719-1720. doi:\href{https://doi.org/10.1136/bmj.316.7146.1719}{10.1136/bmj.316.7146.1719}}

\bibitem[\citeproctext]{ref-chenMethodologicalReviewRandomised2024}
\CSLLeftMargin{17. }%
\CSLRightInline{Hawksworth O, Chatters R, Julious S, Cook A. A methodological review of randomised n-of-1 trials. \emph{Trials}. 2024;25(1):263. doi:\href{https://doi.org/10.1186/s13063-024-08100-1}{10.1186/s13063-024-08100-1}}
...
\CSLLeftMargin{21. }%
\CSLRightInline{Lobo MA, Moeyaert M, Baraldi Cunha A, Babik I. Single-case design, analysis, and quality assessment for intervention research. \emph{Journal of Neurologic Physical Therapy}. 2017;41(3):187-197. doi:\href{https://doi.org/10.1097/NPT.0000000000000187}{10.1097/NPT.0000000000000187}}
...
\CSLLeftMargin{23. }%
\CSLRightInline{Declercq L, Cools W, Beretvas SN, Moeyaert M, Ferron JM, Van den Noortgate W. {MultiSCED}: A tool for (meta-)analyzing single-case experimental data with multilevel modeling. \emph{Behavior Research Methods}. 2019;52(1):177-192. doi:\href{https://doi.org/10.3758/s13428-019-01216-2}{10.3758/s13428-019-01216-2}}

\bibitem[\citeproctext]{ref-mitchellDevelopmentSetKey2024}
\CSLLeftMargin{24. }%
\CSLRightInline{Chatters R, Hawksworth O, Julious S, Cook A. The development of a set of key points to aid clinicians and researchers in designing and conducting n-of-1 trials. \emph{Trials}. 2024;25(1):465. doi:\href{https://doi.org/10.1186/s13063-024-08261-z}{10.1186/s13063-024-08261-z}}
...
\CSLLeftMargin{44. }%
\CSLRightInline{Daza EJ, Wac K, Oppezzo M. Causal analysis of self-tracked time series data using a counterfactual framework for {N-of-1} trials. \emph{AMIA Annual Symposium Proceedings}. 2018;2018:532-541.}
