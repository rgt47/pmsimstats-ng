...
\renewcommand{\stamptime}{2026-06-14 08:50 PDT}
\renewcommand{\stampversion}{\detokenize{2737964-wip}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{lineno}
\linenumbers
...
treatment response\textsuperscript{\citeproc{ref-lillieNof1ClinicalTrial2011}{1},\citeproc{ref-nam2021expanding}{2}}.
...
to personalised therapeutic decision-making\textsuperscript{\citeproc{ref-kravitzSinglepatientNof1Trials2014}{3},\citeproc{ref-marshallScopingReviewRandomized2022}{4}}.
...
personalised treatment-effect estimates\textsuperscript{\citeproc{ref-zuckerIndividualNof1Trials2010}{7},\citeproc{ref-schmidBayesianModelsNof12021}{8}}. When
...
within-patient and between-patient variability\textsuperscript{\citeproc{ref-zuckerIndividualNof1Trials2010}{7}}. Random-effects meta-analysis
...
\begin{orig}
Senn\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{20}} formalised the sample size
...
\(n\) reduces the entire expression proportionally\textsuperscript{\citeproc{ref-zuckerIndividualNof1Trials2010}{7},\citeproc{ref-sennSampleSizeConsiderations2019}{20}}.
...
\begin{orig}
Zucker et al.\textsuperscript{\citeproc{ref-zuckerIndividualNof1Trials2010}{7}} studied the trade-off
...
estimates\textsuperscript{\citeproc{ref-tangTtestsNof1Trials2020}{13}}. Wang and Schork\textsuperscript{\citeproc{ref-wangPowerDesignIssues2019}{21}} demonstrated via likelihood-ratio methods
...
and the population estimate must be jointly optimised\textsuperscript{\citeproc{ref-sennSampleSizeConsiderations2019}{20}}.
...
behavioural and educational research\textsuperscript{\citeproc{ref-kratochwillSinglecaseExperimentalDesigns2013}{22},\citeproc{ref-ledfordSinglecaseDesignAnalysis2018}{23}}. The methodological rigour of
...
chronic, fluctuating nature of symptoms\textsuperscript{\citeproc{ref-raskindReductionNightmaresOther2003}{28}}. Prazosin, an
\(\alpha_1\)-adrenergic receptor antagonist, has demonstrated efficacy
for reducing trauma-related nightmares in multiple RCTs\textsuperscript{\citeproc{ref-Raskind2013Trial}{29},\citeproc{ref-raskindTrialPrazosinPostTraumatic2018}{30}}, though
...
implementation\textsuperscript{\citeproc{ref-vohraCONSORTExtensionReporting2015}{6},\citeproc{ref-kravitzIntroductionNof1Trials2014}{36}}, while specialised software tools
...
\begin{orig}
Wang and Schork\textsuperscript{\citeproc{ref-wangPowerDesignIssues2019}{21}} extended the analytical
...
expression proportionally. Zucker, Ruthazer, and Schmid\textsuperscript{\citeproc{ref-zuckerIndividualTrialsPopulation2010}{41}} compared summary and
...
colleagues\textsuperscript{\citeproc{ref-jiangDesignAnalysis2025}{42}} proposed sequential monitoring
...
application. Selukar, Prince, and May\textsuperscript{\citeproc{ref-selukarFrameworkSequential2025}{43}}
...
alpha-spending corrections. Giai and colleagues\textsuperscript{\citeproc{ref-giaiIndividualizedNet2023}{44}}
...
\begin{orig}
We follow the ADEMP framework of Morris, White, and Crowther\textsuperscript{\citeproc{ref-morrisUsingSimulationStudies2019a}{45}}: Aims, Data-generating mechanisms,
...
following the paired-comparison discipline of Morris et al.\textsuperscript{\citeproc{ref-morrisUsingSimulationStudies2019a}{45(sec5.4)}}. Each replicate begins by
...
\begin{orig}
\textbf{N-of-1 arm.} Each replicate is analysed with the linear mixed-effects
model
...
\begin{orig}
Random-number discipline follows Morris et al.\textsuperscript{\citeproc{ref-morrisUsingSimulationStudies2019a}{45(sec4.6)}}.
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item N-of-1 power was 100.0% (MCSE 0.0 pp) versus 67.5% for the RCT.
\item The Morris paired design yields a within-replicate power difference of 0.325 with paired MCSE 0.0105.
...
100.0\% (MCSE
0.0 pp)
for the aggregated N-of-1 hybrid. Under the Morris\textsuperscript{\citeproc{ref-morrisUsingSimulationStudies2019a}{45(sec5.4)}} paired design, the
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item N-of-1 power was 100\% (MCSE 0\%) versus 67.6\% for the RCT.
\item The 95\% Monte Carlo CI for the N-of-1 power is 100--100\%.
\item The power difference of 32.5 percentage points exceeds five combined MCSEs.
\end{itemize}
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item The N-of-1 relative SE error is -0.021, confirming analytical SEs are well-calibrated.
\item Coverage of nominal-95\% CIs is 94.0% for N-of-1 and 93.8% for RCT at the primary cell.
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item At $\beta_D = -0.5$ nightmares per week, the RCT reaches only 10.4% power while the N-of-1 hybrid reaches 31.1%\%.
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item The N-of-1 bias is +0.011 at $-0.5$, +0.011 at $-1.0$, and +0.011 at $-2.0$.
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item The RCT design showed Type I error of 6.2\% (95\% CI 5.1--7.2\%).
\item The N-of-1 design showed Type I error of 5.1\% (95\% CI 4.1--6.1\%).
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item At the primary cell, the exponential decay model yields N-of-1 power of 83.0%.
...
\textbf{The individual treatment-effect estimate from the representative trial, comparing 4 prazosin periods with 3 pure placebo periods, is close to the true effect size.}

\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item The individual estimate of -2.34 nightmares per week is consistent with the true effect.
...
expected to be substantial\textsuperscript{\citeproc{ref-lillieNof1ClinicalTrial2011}{1},\citeproc{ref-nam2021expanding}{2}}.
...
otherwise difficult\textsuperscript{\citeproc{ref-ncbi2012small}{46}}.
...
there is substantial individual variation in treatment response\textsuperscript{\citeproc{ref-raskindTrialPrazosinPostTraumatic2018}{30}}; the relatively short
...
specialised software tools\textsuperscript{\citeproc{ref-hussey2020sced}{37}} and standardised reporting
...
\begin{orig}
The integration of Bayesian approaches\textsuperscript{\citeproc{ref-schmidBayesianModelsNof12021}{8}} and adaptive design elements\textsuperscript{\citeproc{ref-dazaCausalAnalysisSelftracked2018}{47}} represents a promising direction
...
optimise treatment selection based on individual patient characteristics\textsuperscript{\citeproc{ref-lillieNof1ClinicalTrial2011}{1},\citeproc{ref-nam2021expanding}{2}}. N-of-1 trials
...
require modelling approaches not examined here\textsuperscript{\citeproc{ref-dazaCausalAnalysisSelftracked2018}{47}}.
...
design targets differ. Comparisons with Shi and Ye\textsuperscript{\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}} (behavioural carryover), Pequignat
et al.\textsuperscript{\citeproc{ref-pequignatIdiographicPower2023}{48}} (idiographic power), and Chen,
...
\begin{orig}
Unfortunately, three comparisons remain incomplete: Shi and Ye\textsuperscript{\citeproc{ref-yapBehavioralCarryoverEffect2024}{14}} on behavioural carryover in
2-period crossovers, Pequignat and colleagues\textsuperscript{\citeproc{ref-pequignatIdiographicPower2023}{48}} on idiographic power for
...
\emph{Rendered on 2026-06-14 at 08:50 PDT.}\\
