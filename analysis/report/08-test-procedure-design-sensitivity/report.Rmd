...
\item Huynh-Feldt and Greenhouse-Geisser corrections recover nominal Type I only conditionally; the threshold is $\epsilon < 0.6$ per Blanca et al. (2023).
...
\item Results are reported following the Morris et al. (2019) ADEMP discipline including Monte Carlo standard errors.
\end{itemize}
:::
...
\item All estimates are reported with Monte Carlo standard errors following the Morris et al. (2019) discipline.
\end{itemize}
:::
