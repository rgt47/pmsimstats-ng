...
designed and reported under the\textsuperscript{\citeproc{ref-morris2019simulation}{1}} ADEMP framework,
...
CONSORT extension reporting standards\textsuperscript{\citeproc{ref-vohraCONSORTExtensionReporting2015}{14},\citeproc{ref-shamseer2015cent}{15}} codify reporting quality but do not address
...
procedure.\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{28}} compare aggregated N-of-1
...
and\textsuperscript{\citeproc{ref-zucker2010}{30}} synthesize the broader N-of-1 design
...
standard cross-over methodology\textsuperscript{\citeproc{ref-senn1994crossover}{9},\citeproc{ref-senn2002}{33}} to the biomarker-stratified case and clarifies
...
reported in the\textsuperscript{\citeproc{ref-morris2019simulation}{1}} ADEMP framework adopted as the
...
bias \(\delta\) used in the companion calibration manuscript\textsuperscript{\citeproc{ref-pmsimstats-paper10}{38}})
...
\begin{orig}
The simulation program follows the ADEMP framework of\textsuperscript{\citeproc{ref-morris2019simulation}{1}}. The primary estimand is the biomarker-treatment
