...
designed and reported under the @morris2019simulation ADEMP
framework. The study crosses five test procedures: strict
RM-ANOVA on the dichotomized biomarker, a continuous-biomarker
within-subject contrast, the standard pmsimstats linear-mixed
analysis with `corCAR1`, and GEE with naive and with
Mancl-DeRouen small-sample sandwich variance. These procedures
are crossed against the biomarker-moderation coefficient
$\beta_{bm} \in \{0, 0.45\}$ and sample size $N \in \{25, 35, 70,
100\}$, a 40-cell factorial at the prazosin-PTSD reference
design, with 1000 replicates per power cell and 2000 per Type I
cell.
