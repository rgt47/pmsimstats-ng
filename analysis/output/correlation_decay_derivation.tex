...
\pagestyle{fancy}
\fancyhf{}
\rhead{BM--BR Correlation Decay Derivation}
\lhead{pmsimstats White Paper}
\rfoot{\thepage}

\title{Deriving the Biomarker--Treatment Correlation\\
       Decay from First Principles\\[6pt]
       \large A Pharmacokinetic Argument for Proportional
       Scaling in the pmsimstats Data-Generating Process}
