...
\fancypagestyle{plain}{%
  ...
  \renewcommand{\headrulewidth}{0pt}%
  \renewcommand{\footrulewidth}{0.4pt}}
\renewcommand{\stampsource}{\textasciitilde{}/\allowbreak{}prj/\allowbreak{}res/\allowbreak{}36-pmsimstats-ng/\allowbreak{}pmsimstats-ng/\allowbreak{}analysis/\allowbreak{}report/\allowbreak{}02-carryover-sensitivity/\allowbreak{}report-extra-slim.Rmd}
\renewcommand{\stamptime}{2026-07-10 00:13 AEST}
...
commits to a parametric decay form and half-life (\textbf{A2}, the
...
(\textbf{A3}, the classical crossover device of Jones and Kenward\textsuperscript{\citeproc{ref-jones2014crossover}{4}}). We cross these against the exponential and
...
because A2 and A3 see the \emph{same} trials, they can be compared with a
...
In the crossover design it is much \emph{worse} (0.488 vs 0.830 for A3).
...
here. \textbf{Assumed half-life (Fig. \ref{fig:fig-sens-s2}).} A3 does
...
about 0.83 to 0.77, never below A3. \textbf{Autocorrelation
...
\emph{Rendered on 2026-07-10 at 00:13 AEST.}\\
