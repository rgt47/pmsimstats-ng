...
the placebo response is mediated by well-characterised
...
::: {.bullets data-latex=""}
\textbf{The production programme follows the ADEMP framework with four deliverables; the realised Study A run in section 7.3 is the first of these.}
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
...
::: {.orig data-latex=""}
The production programme follows the @morris2019 ADEMP framework and
...
a function of $(m_{BR}, m_{PB}, m_{TV})$, which the lumped-total
...
run reported next used 250 replicates per cell.
:::
