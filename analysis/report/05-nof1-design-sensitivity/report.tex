...
Morris et al.\textsuperscript{\citeproc{ref-morris2019simulation}{1}}.

\textbf{Results.} At a baseline of \(N = 35\) participants per design, the
...
mixed-effects machinery to support population-level inference\textsuperscript{\citeproc{ref-lillie2011}{2},\citeproc{ref-kravitzSinglepatientNof1Trials2014}{3}}. Several recent
...
colleagues\textsuperscript{\citeproc{ref-hendricksonOptimizing2020}{5}} for predictive-biomarker
...
below 1\% per Morris et al.\textsuperscript{\citeproc{ref-morris2019simulation}{1}}.
...
adopted by Blackston\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{4}},
...
profiles under carryover, as documented in\textsuperscript{\citeproc{ref-hendricksonOptimizing2020}{5}}. We cross the two architectures in
...
\begin{quote}
\textbf{TODO (blocks acceptance): stale Results baseline.} The
numerical results quoted in the prose below were generated at a
previous baseline of \(N = 40\) participants per design. The
driver code in \texttt{00-common.R} (\texttt{baseline\_model\_param(N\ =\ 35,\ ...)})
already defaults to the manuscript's stated \(N = 35\) baseline, and
a 2026-08-16 smoke-test run
(\texttt{analysis/scripts/nof1-design-sensitivity/00-smoke-test.R})
confirms the current pipeline produces valid, non-NA output; the
discrepancy is therefore that the twelve \texttt{.rds} sweep artifacts
under \texttt{analysis/data/derived\_data/sensitivity/} have not yet been
...
\texttt{Rscript\ analysis/scripts/nof1-design-sensitivity/run-all.R}
...
The primary N-of-1 design is the Hendrickson 2020\textsuperscript{\citeproc{ref-hendricksonOptimizing2020}{5}} hybrid, that is, open-label titration
...
forms, consistent with the finding of Gärtner 2023\textsuperscript{\citeproc{ref-gaertnerCarryover2023}{7}} that misspecification of the carryover
...
more than roughly 50\%. Wang and Schork 2019\textsuperscript{\citeproc{ref-wang2019}{10}} note this tradeoff explicitly,
...
within-subject. We note that Blackston 2019's\textsuperscript{\citeproc{ref-blackstonComparisonAggregatedNof12019}{4}} observation, that
...
Hendrickson is, first, in its Morris\textsuperscript{\citeproc{ref-morris2019simulation}{1}}
