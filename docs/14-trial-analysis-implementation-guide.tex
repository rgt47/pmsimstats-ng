...
\begin{itemize}
  \item \texttt{analysis/scripts/figure4/04-generate-power-head.R}: Figure 4 simulation (current code)
  \item \texttt{analysis/scripts/figure4/01-generate-power-sweep.R}: Figure 4 power sweep (sequential)
  \item \texttt{analysis/scripts/figure4/02-generate-power-sweep-original.R}: Publication reproduction
  \item \texttt{analysis/scripts/figure4/03-generate-power-by-commit.R}: Per-commit comparison
  \item \texttt{analysis/scripts/figure4/05-pd-diagnostics.R}: PD failure instrumentation
  \item \texttt{analysis/scripts/figure4/06-plot-power-heatmaps.R}: Heatmap plotting
