...
predictor values handed to `lme`, not through the model formula,
...
[-@jones2014crossover]. One structural feature of A3 is worth
...
tradition represented by Jones and Kenward [-@jones2014crossover]
...
1. **A2 helps, but only under certain conditions.** The
...
2. **A roughly guessed half-life is adequate, where A2 is used.**
...
4. **The interaction test is somewhat conservative, and the problem
