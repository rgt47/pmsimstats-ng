...
\midrule
\texttt{04-revised-power-analysis.pdf} & 13 & Main paper: problems, fixes, validated results \\
\texttt{18-response-parameter-sensitivity.pdf} & 6 & Response parameter sensitivity before/after \\
\texttt{08-biomarker-correlation-decay.pdf} & 10 & Pharmacokinetic derivation of lambda\_cor \\
\texttt{06-ar1-residual-correlation.pdf} & 8 & lmer to nlme transition with Type I error validation \\
\texttt{07-positive-definiteness-failures.pdf} & 10 & PD failure prevalence and causes \\
\texttt{09-carryover-correlation-artifact.pdf} & 10 & BM-BR correlation artifact analysis \\
\texttt{05-revision-summary.pdf} & 12 & Revision summary with before/after heatmaps and code change appendix \\
\bottomrule
\end{tabular}
\end{table}
