...
per Morris et al. [-@morris2019using].
...
1% per Morris et al. [-@morris2019using].
:::
...
*Source: `~/prj/res/36-pmsimstats-ng/pmsimstats-ng/analysis/report/05-nof1-design-sensitivity/report.Rmd`*
