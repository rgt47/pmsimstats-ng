...
review (2026-04-09).} This document reviews
\texttt{analysis/2025/pm\_functions.R}, the pre-merge
exploratory tidyverse code that has since been moved to an
external archive at
\texttt{\textasciitilde/Dropbox/prj/alz/10-pmsimstats-ng/archive/2025/}.
The maintained tidyverse implementation now lives in
\texttt{implementations/tidyverse/R/functions.R} and was
restructured during the 2026-04-08 merge that introduced the
\texttt{implementations/} directory. This document is retained
as a record of the issues identified in the original code; many
of the dead-code and duplication findings noted here informed
the rewrite, but the line numbers and function names refer to
the archived file and should not be applied to the current
