...
equation \\eqref{eq:rmanova-f-22} to the pmsimstats `nlme::lme`
...
DGP, as we shall develop in the next subsection.
\textbackslash end\{orig\}
...
\item
  ...
  framework's likelihood-based handling of MAR data\textsuperscript{\citeproc{ref-mallinckrodt2008recommendations}{2}} is genuinely
  better-behaved.
\item
