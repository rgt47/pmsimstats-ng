...
\pagestyle{fancy}
\fancyhf{}
\rhead{Biomarker--BR Correlation Scaling}
\lhead{pmsimstats White Paper}
\rfoot{\thepage}

\title{Biomarker--Treatment Correlation During Carryover:\\
       A Modeling Artifact in the pmsimstats\\
       Data-Generating Process\\[6pt]
       \large White Paper on the Impact of Correlation
       Assignment Rules on Simulated Power Estimates}
...
in the publication. We trace the mathematics of the artifact,
...
publication's findings and our simulation results.
...
{\footnotesize Rendered on 2026-03-19 at 17:37 PDT.}\\
\noindent Source: \textasciitilde/prj/alz/01c-pmsimstats-orig/%
pmsimstats/analysis/output/correlation\_scaling\_white\_paper.tex}}
