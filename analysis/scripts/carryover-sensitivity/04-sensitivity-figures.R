## analysis/scripts/carryover-sensitivity/04-sensitivity-figures.R
##
## Render manuscript-02 sensitivity-block figures (Tier 2). One PDF
## per block written to analysis/figures/02-sens-{S1..S5}.pdf.
##
## Behaviour when Tier 2 results are not yet available:
## analysis/data/02-sensitivity-summary.rds is missing -> each
