...
\renewcommand{\stamptime}{2026-06-13 17:57 PDT}
...
\textbf{Results.} The identity shows that the lumped
...
modern clinical pharmacology is antidepressant efficacy.\textsuperscript{\citeproc{ref-kirsch2008}{6}} analysed FDA-submitted data on four widely-
...
depression and explicitly invoked regression to the mean.\textsuperscript{\citeproc{ref-sugarman2014}{8}} generalised the finding to anxiety. Patient
...
treatment response, formalised in the PATH statement\textsuperscript{\citeproc{ref-kent2020path}{14},\citeproc{ref-kent2020pathee}{15}}. A biomarker that correlates
...
\begin{orig}
The N-of-1 trial in its modern randomised form originates with\textsuperscript{\citeproc{ref-guyatt1986}{18}}, who defined the within-patient multiple-crossover
...
regular use of placebo treatments\textsuperscript{\citeproc{ref-tilburt2008}{46}}. The placebo
response is mediated by well-characterised neurobiological
pathways\textsuperscript{\citeproc{ref-benedetti2014}{38}--\citeproc{ref-carlino2016benedetti}{41},\citeproc{ref-finniss2010}{47}}. Belief-driven release of endogenous
...
pharmacology. The neuroimaging evidence is instructive:\textsuperscript{\citeproc{ref-wager2013nps}{42}} developed an fMRI-based `neurologic pain
signature' that is reduced by remifentanil, and\textsuperscript{\citeproc{ref-zunhammer2018nps}{43}}
...
correlates of placebo responsiveness\textsuperscript{\citeproc{ref-hall2012comt}{9},\citeproc{ref-wang2022comt}{10}} further establish that placebo response is a
...
emphasised by\textsuperscript{\citeproc{ref-senn2004}{49}}: components that combine
...
of\textsuperscript{\citeproc{ref-hrobjartsson2001}{11}},\textsuperscript{\citeproc{ref-hrobjartsson2004}{12}}, and\textsuperscript{\citeproc{ref-hrobjartsson2010}{13}},
...
provides the most consequential modern example:\textsuperscript{\citeproc{ref-kirsch2008}{6}},
...
response and natural fluctuation;\textsuperscript{\citeproc{ref-locher2015}{7}} explicitly invoked
...
the vocabulary of the estimands framework\textsuperscript{\citeproc{ref-iche9r1}{51}}, because
...
difficulty Senn has emphasised for individual treatment effects\textsuperscript{\citeproc{ref-senn2004}{49},\citeproc{ref-senn2018}{52}}: a genuine participant-by-component signal
...
Daza\textsuperscript{\citeproc{ref-daza2018}{53}} formalises an average-period treatment-effect
estimand built to accommodate autocorrelation, trend, and slow
carryover jointly; and G\{"a\}rtner et al.\textsuperscript{\citeproc{ref-gartner2023}{54}}
...
\subsection{What the lumped analysis estimates}\label{what-the-lumped-analysis-estimates}
...
is structured under the\textsuperscript{\citeproc{ref-morris2019}{55}} ADEMP framework, specifying
...
\begin{orig}
The production programme follows the\textsuperscript{\citeproc{ref-morris2019}{55}} ADEMP framework.
...
\subsection{Study A results: bias and power at 250 replicates per cell}\label{study-a-results-bias-and-power-at-250-replicates-per-cell}
...
precision-medicine question, formalised in the PATH statement\textsuperscript{\citeproc{ref-kent2020path}{14}}. Whether it depends on the BR-PB-TV decomposition
...
caveat that\textsuperscript{\citeproc{ref-senn2018}{52}} and\textsuperscript{\citeproc{ref-senn2004}{49}} raise for individual
...
developed at the group level\textsuperscript{\citeproc{ref-holford2015}{1},\citeproc{ref-gomeni2009}{2}}. We
...
\subsection{Interpretation of the pilot diagnostics}\label{interpretation-of-the-pilot-diagnostics}
...
\emph{Rendered on 2026-06-13 at 17:57 PDT.}\\
