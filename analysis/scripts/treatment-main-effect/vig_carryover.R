#' vig_carryover.R: Self-contained script for carryover effects simulation in Hybrid N-of-1 Design
#'
#' This is a monolithic script that contains all the code needed to run the
#' Monte Carlo simulation from the carryover_only vignette. It focuses specifically
#' on the effects of carryover in the Hybrid N-of-1 clinical trial design.
