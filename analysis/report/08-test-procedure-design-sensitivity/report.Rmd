...
::: {.bullets data-latex=""}
\textbf{The factorial crosses five procedures by two $c_{bm}$ values by four $N$ values; the inline Mancl-DeRouen SE is benchmarked against \texttt{geesmv::GEE.var.md}.}
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item The simulation crosses five procedures by $c_{bm} \in \{0, 0.45\}$ by $N \in \{25, 35, 70, 100\}$, with 1000 replicates per power cell and 2000 per Type I cell.
...
$c_{bm} = 0.45$, 1000 replicates per cell.
...
Table: (\#tab:secondary) Secondary estimands at $c_{bm} = 0.45$
