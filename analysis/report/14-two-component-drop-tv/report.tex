...
\fancypagestyle{plain}{%
  ...
  \renewcommand{\headrulewidth}{0pt}%
  \renewcommand{\footrulewidth}{0.4pt}}
\renewcommand{\stampsource}{\textasciitilde{}/\allowbreak{}prj/\allowbreak{}res/\allowbreak{}36-pmsimstats-ng/\allowbreak{}pmsimstats-ng/\allowbreak{}analysis/\allowbreak{}report/\allowbreak{}14-two-component-drop-tv/\allowbreak{}report.Rmd}
\renewcommand{\stamptime}{2026-09-09 09:22 PDT}
...
\makeatother
\hypersetup{
  pdftitle={Data generation machinery for N-of-1 clinical trial simulations under a two-component response decomposition: dropping the natural-history component},
  pdfauthor={pmsimstats team},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Data generation machinery for N-of-1 clinical trial simulations under a two-component response decomposition: dropping the natural-history component}
...
throughout. At 500 replicates the Monte Carlo standard error on
power does not exceed 0.022,
...
\begin{table}
\centering
\caption{\label{tab:tab-main}Power by architecture, trial design and carryover
    half-life at $c_{bm} = 0.30$, $N = 70$, 500 replicates per cell.
...
\toprule
Architecture & Design & $t_{1/2}=0$ & $0.5$ & $1.0$ & Cost\\
\midrule
Covariance (B) & CO & 0.746 & 0.786 & 0.768 & -0.022\\
Covariance (B) & Hybrid & 0.878 & 0.778 & 0.684 & +0.194\\
Covariance (B) & OL+BDC & 0.746 & 0.610 & 0.550 & +0.196\\
Mean (A) & CO & 0.768 & 0.746 & 0.770 & -0.002\\
Mean (A) & Hybrid & 0.842 & 0.836 & 0.802 & +0.040\\
\addlinespace
Mean (A) & OL+BDC & 0.754 & 0.692 & 0.676 & +0.078\\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{table}
\centering
\caption{\label{tab:tab-ref}The same comparison at paper 01's reference cell
...
Architecture & Design & $t_{1/2}=0$ & $0.5$ & $1.0$ & Cost\\
\midrule
Covariance (B) & CO & 0.982 & 0.992 & 0.976 & +0.006\\
Covariance (B) & Hybrid & 0.998 & 0.994 & 0.966 & +0.032\\
Covariance (B) & OL+BDC & 0.988 & 0.968 & 0.890 & +0.098\\
Mean (A) & CO & 0.972 & 0.992 & 0.976 & -0.004\\
Mean (A) & Hybrid & 0.992 & 0.986 & 0.990 & +0.002\\
\addlinespace
Mean (A) & OL+BDC & 0.976 & 0.980 & 0.966 & +0.010\\
\bottomrule
\end{tabular}}
\end{table}
...
\caption{\label{tab:tab-type1}Empirical Type I error at the null
    ($c_{bm} = 0$), pooled within trial design over both
    architectures, both sample sizes and all three carryover
    half-lives (500 replicates per cell). Nominal level 0.05.}
\centering
\begin{tabular}[t]{lrlll}
\toprule
Design & cells & Rejection rate & SE & z vs 0.05\\
\midrule
CO & 12 & 0.061 & 0.0031 & +3.6\\
Hybrid & 12 & 0.039 & 0.0025 & -4.5\\
OL+BDC & 12 & 0.021 & 0.0018 & -15.8\\
\bottomrule
\end{tabular}
\end{table}
...
No biomarker-TV parameter exists anywhere in the
...
The asymmetry here is one-sided.
...
Against those two stands the argument paper
...
\paragraph{Our reading.}

For work internal to this program, where the
...
\item
  \textbf{The architecture comparison survives the reduction.} Under
...
\item
  \textbf{TV is a variance term, unconditionally.} No biomarker-TV
...
\item
  \textbf{The reference cell should not be used to read the
  ...
  headline.
\item
  \textbf{Type I error is design-dependent.} Pooled rejection rates
...
\item
  \textbf{The reduction is appropriate for comparative
...
\item
  \textbf{This reduction preserves the design structure; the
