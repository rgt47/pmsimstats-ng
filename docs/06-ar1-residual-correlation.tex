...
\caption{Power at $c_{bm} = 0.5$, no censoring, with
  ...
  $\lambda_{cor} = \ln 2 / t_{1/2}$ (auto). Note:
  $c_{bm} = 0.5$ slightly exceeds the PD-feasible ceiling of
  approximately 0.45 for some trial designs under
  Architecture~B; results at this value may reflect silent
