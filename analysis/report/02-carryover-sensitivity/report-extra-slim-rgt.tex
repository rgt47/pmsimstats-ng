...
\renewcommand{\stamptime}{2026-07-29 11:10 PDT}
\renewcommand{\stampversion}{\detokenize{fdfa40e-wip}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{setspace}
\setstretch{1.0}
...
design A2 is markedly inferior (0.488 vs 0.830 for A3, which tracks
the binary indicator closely). Where A2 leads, the lead appears
...
Architecture B we recommend the exposure-weighted predictor A2,
reported with a cluster-robust standard error, for the Hybrid and
OL+BDC designs; the lagged-treatment specification A3 is preferable,
...
binary on-drug specification (A1) or Architecture A (mean
...
crossover-trial tradition surveyed by Jones and Kenward\textsuperscript{\citeproc{ref-jones2014crossover}{4}}. One structural feature of A3 bears directly
...
\item
  \textbf{A2 helps, but conditionally.} The exposure-weighted predictor
  ...
  (Block S6).
\item
  \textbf{An approximate half-life is adequate, where A2 is used.}
...
\emph{Rendered on 2026-07-29 at 11:10 PDT.}\\
