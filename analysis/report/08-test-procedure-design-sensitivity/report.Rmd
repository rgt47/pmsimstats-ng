...
correlation. We then conduct a Monte Carlo simulation study that
crosses three test procedures (strict RM-ANOVA, the standard
pmsimstats linear-mixed analysis, and a generalised estimating
equations comparator) against a grid of design parameters: number
of cycles $k \in \{1, 2, 3, 4, 6\}$, on-drug period length in
weeks, off-drug period length, and on/off symmetry. Each cell is
simulated at the prazosin-PTSD reference parameters with
$n_{\text{reps}} = 1000$.
...
parameter grid considered here. We provide a design-and-test
recommendation table for typical chronic-condition N-of-1 trials.
