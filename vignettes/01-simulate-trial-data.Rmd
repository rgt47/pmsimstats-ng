...
This vignette is designed to walk through the steps used to generate simulated N-of-1 trial results with the pmsimstats package, of the kind reported in the package's companion manuscripts under `analysis/report/`. The steps fall into four basic steps:
