...
Daza [@daza2018] formalizes an average-period treatment-effect
...
::: {.orig data-latex=""}
The production program follows the @morris2019 ADEMP framework and
...
\begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}
\item At $N=150$, the decomposition's bias of $\hat\beta_{bm:D_{bc}}$ stays within one MCSE of zero across $c_{bm,PB} \in \{0, 0.1, 0.2, 0.3\}$ ($-0.022$, $+0.008$, $+0.021$, $-0.026$; MCSE $\approx 0.02$), while the one-component bias rises monotonically to $+0.16$, $+0.34$, $+0.48$.
