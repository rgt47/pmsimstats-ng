...
crossover-trial tradition surveyed by Jones and Kenward\textsuperscript{\citeproc{ref-jones2014crossover}{4}}. One structural feature of M3 bears directly
...
\item
  \textbf{M2 helps, but conditionally.} The exposure-weighted predictor
  ...
  (Block S6).
\item
  \textbf{An approximate half-life is adequate, where M2 is used.}
