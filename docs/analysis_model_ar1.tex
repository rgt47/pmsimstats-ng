...
\pagestyle{fancy}
\fancyhf{}
\rhead{Analysis Model with AR(1) Residuals}
\lhead{pmsimstats White Paper}
\rfoot{\thepage}

\title{Matching the Analysis Model to the\\
       Data-Generating Process:\\
       AR(1) Residual Correlation in the\\
       pmsimstats LME Analysis\\[6pt]
       \large White Paper on Type I Error Control Under
...
{\footnotesize Rendered on 2026-03-21.}\\
\noindent Source: \textasciitilde/prj/alz/01c-pmsimstats-orig/%
pmsimstats/analysis/output/analysis\_model\_ar1.tex}}
