...
\textbf{Results.} E2 attains the highest power only in the two designs
...
\textbf{Conclusions.} Three points warrant emphasis. First, under
...
\subsubsection{E2: exposure-weighted (continuous predictor)}\label{e2-exposure-weighted-continuous-predictor}
...
\subsubsection{E3: lagged-treatment (estimated carryover term)}\label{e3-lagged-treatment-estimated-carryover-term}
...
crossover-trial tradition surveyed by Jones and Kenward\textsuperscript{\citeproc{ref-jones2014crossover}{4}}. One structural feature of E3 bears directly
...
\caption{\label{tab:grid-table}Principal simulation grid (the covariance-moderation architecture only). Cell 1
...
\midrule
0.0 & E2 & 0.988 (0.005) & -0.029 (0.033) & 0.746 & 0.990 (0.004) & 0.557 (0.034) & 0.000\\
0.0 & E3 & 0.990 (0.004) & -0.025 (0.033) & 0.746 & 0.990 (0.004) & 0.557 (0.034) & 0.000\\
0.5 & E2 & 0.948 (0.010) & +0.072 (0.041) & 0.907 & 0.972 (0.007) & 0.828 (0.057) & 0.000\\
0.5 & E3 & 0.920 (0.012) & +0.583 (0.036) & 0.812 & 0.938 (0.011) & 1.000 (0.059) & 0.000\\
1.0 & E2 & 0.860 (0.016) & -0.081 (0.049) & 1.085 & 0.968 (0.008) & 1.184 (0.077) & 0.000\\
\addlinespace
1.0 & E3 & 0.770 (0.019) & +1.099 (0.038) & 0.853 & 0.818 (0.017) & 1.935 (0.094) & 0.000\\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{../../figures/02xs-power-by-spec} \caption{Power versus carryover half-life under the exponential DGP, the covariance-moderation architecture, stratified by analysis specification. E2 retains a modest advantage over E3 in the Hybrid and OL+BDC designs at $t_{1/2} = 1.0$ weeks, but is dominated by E3 under the crossover (CO) design.}\label{fig:fig-power-by-spec}
\end{figure}
...
\midrule
E2 & 1.10 & 0.029 & 1.00 & 0.045\\
E3 & 1.05 & 0.039 & 0.98 & 0.049\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}
\centering
\caption{\label{tab:tab-s6}Cluster-robust recalibration of E2 (Power columns) and
...
\toprule
Cell & $\kappa$ model & $\kappa$ CR2 & Power model & Power CR2 & E2$-$E3 model & E2$-$E3 CR2 & CR2 df\\
\midrule
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{../../figures/02xs-sens-S2} \caption{Power of E2 and E3 as the analyst's assumed half-life departs from the true DGP half-life. E3 is invariant to the assumed half-life by construction; E2's power degrades with mis-specification.}\label{fig:fig-sens-s2}
\end{figure}
...
\subsection{The principal finding, and the conditions under which it fails}\label{the-principal-finding-and-the-conditions-under-which-it-fails}
...
\item
  \textbf{E2 helps, but conditionally.} The exposure-weighted predictor
  ...
  (Block S6).
\item
  \textbf{An approximate half-life is adequate, where E2 is used.}
...
\item
  ...
  (Block S6).
\item
  \textbf{This is a narrowed slice of a larger study.} the mean-moderation architecture,
...
\texttt{E1}, \texttt{E2}, \texttt{E3} in the simulation output, in the drivers, and in this
manuscript, so no display-time relabelling is applied. Output archived
before 2026-07-31 stores them as \texttt{A1}, \texttt{A2}, \texttt{A3}; the migration
