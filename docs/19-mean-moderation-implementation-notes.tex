...
2025 tidyverse codebase (initial commit \texttt{957c8bd},
file \texttt{pm\_functions.R}; this codebase has since been
moved to an external archive and is no longer part of the
working repository):
%
\begin{equation}
  \text{BR}_{it}^{\text{mod}} = \text{BR}_{it}^{\text{base}}
