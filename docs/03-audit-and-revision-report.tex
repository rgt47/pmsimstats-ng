...
\subsection{Revised Power Analysis (04-revised-power-analysis.pdf)}
...
\subsection{AR(1) Residual Correlation (06-ar1-residual-correlation.pdf)}

Derives why the original \texttt{lme4::lmer} random-intercept model
produces inflated Type I error (13--17\%) under the AR(1) DGP
and validates that \texttt{nlme::lme} with \texttt{corCAR1} corrects this
...
\subsection{Biomarker Correlation Decay (08-biomarker-correlation-decay.pdf)}
...
\subsection{Positive Definiteness Failures (07-positive-definiteness-failures.pdf)}
...
perturbation introduced by \texttt{make.positive.definite()} and its
...
\subsection{Carryover Correlation Artifact (09-carryover-correlation-artifact.pdf)}
...
\subsection{Response Parameter Sensitivity (18-response-parameter-sensitivity.pdf)}
