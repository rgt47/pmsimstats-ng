...
\textbf{Results.} {[}Forthcoming.{]} The closed-form strict RM-ANOVA test
...
discontinuation design\textsuperscript{\citeproc{ref-hendrickson2020}{1}}, dominates the strict
...
strict RM-ANOVA.\textsuperscript{\citeproc{ref-haverkamp2017sphericity}{2}} show through
...
Greenhouse-Geisser corrections\textsuperscript{\citeproc{ref-huynh1976}{3},\citeproc{ref-greenhouse1959}{4}}
...
the average treatment effect.} The PATH framework\textsuperscript{\citeproc{ref-kent2020path}{6},\citeproc{ref-kent2020pathee}{7}} makes the methodological
...
within-subject contrast structure.}\textsuperscript{\citeproc{ref-senn1994crossover}{8}} and\textsuperscript{\citeproc{ref-senn2011individual}{9}} establish, in the broader cross-over
...
correlation.} The systematic review of\textsuperscript{\citeproc{ref-natesanbatley2023}{10}}
documents that 83.8\% of the published N-of-1 studies they
catalogue ignore autocorrelation entirely;\textsuperscript{\citeproc{ref-stunnenberg2022}{11}} and\textsuperscript{\citeproc{ref-shaffer2018}{12}} reach similar conclusions in neurology and
behavioural-medicine subdomains. CONSORT extension reporting
standards\textsuperscript{\citeproc{ref-vohra2015cent}{13},\citeproc{ref-shamseer2015cent}{14}} codify reporting
quality but do not address the analytic-model decision in any
detail;\textsuperscript{\citeproc{ref-kwasnicka2019}{15}} identifies the analytic-method gap as
...
colleagues\textsuperscript{\citeproc{ref-mallinckrodt2003}{16}--\citeproc{ref-prakash2008}{19}} applies to
parallel-group longitudinal trials with monotone missingness,
not to aggregated N-of-1 designs. The GEE methodology of\textsuperscript{\citeproc{ref-liang1986}{20}} with sandwich variance estimation has been adapted
to small-cluster settings via bias-corrected estimators\textsuperscript{\citeproc{ref-wang2016geesmv}{21},\citeproc{ref-pan2001}{22}}, but the small-sample concerns are
acute at trial-relevant N-of-1 cluster counts:\textsuperscript{\citeproc{ref-tong2024stepwedge}{23}}
...
\textbf{Design-parameter optimisation has been studied separately.}\textsuperscript{\citeproc{ref-hedges2022power}{24}} develop power calculations for \((AB)^k\)
designs that match the N-of-1 within-subject contrast
structure;\textsuperscript{\citeproc{ref-bouwmeester2020}{25}} document strong autocorrelation
effects on permutation-test power;\textsuperscript{\citeproc{ref-senn2011individual}{9}}
...
framework\textsuperscript{\citeproc{ref-hendrickson2020}{1}} is the only paper retrieved that
compares full design families head-to-head for the biomarker-
interaction power question, but it holds period length fixed
and uses a single test procedure.\textsuperscript{\citeproc{ref-schork2023precision}{26}} and\textsuperscript{\citeproc{ref-zucker2010combining}{27}} synthesise the broader N-of-1 design
literature without addressing the joint design-by-test
sensitivity question.

\textbf{The joint design-by-test sensitivity question appears
unanswered.} Across the recent systematic reviews\textsuperscript{\citeproc{ref-natesanbatley2023}{10},\citeproc{ref-stunnenberg2022}{11},\citeproc{ref-defelippe2023}{28}} and the
...
exclude placebo responders before randomisation.\textsuperscript{\citeproc{ref-berger2003runin}{29}} show formally that response-based exclusion
...
extends standard cross-over methodology\textsuperscript{\citeproc{ref-senn1994crossover}{8},\citeproc{ref-senn2002crossover}{30}} to the biomarker-stratified case and
clarifies the connection to the contemporary
sphericity-violation literature\textsuperscript{\citeproc{ref-haverkamp2017sphericity}{2},\citeproc{ref-blanca2023sphericity}{5}}.
...
with bias-corrected sandwich variance per\textsuperscript{\citeproc{ref-wang2016geesmv}{21}})
...
reported in the\textsuperscript{\citeproc{ref-morris2019}{31}} ADEMP framework adopted as the
...
equations\textsuperscript{\citeproc{ref-liang1986}{20}}, and ANCOVA with random subject effects,
...
correction\textsuperscript{\citeproc{ref-greenhouse1959}{4}} estimates \(\hat\epsilon\) from the
...
correction\textsuperscript{\citeproc{ref-huynh1976}{3}} is a less-conservative variant
recommended when \(\hat\epsilon > 0.75\). The contemporary
sphericity-violation literature\textsuperscript{\citeproc{ref-haverkamp2017sphericity}{2},\citeproc{ref-blanca2023sphericity}{5}} documents substantial Type I error
...
For the founding pmsimstats interaction question\textsuperscript{\citeproc{ref-hendrickson2020}{1}}, the strict-RM-ANOVA test is therefore a
...
on/off symmetry around the\textsuperscript{\citeproc{ref-hendrickson2020}{1}} hybrid reference is
...
The simulation programme follows the ADEMP framework of\textsuperscript{\citeproc{ref-morris2019}{31}}. The \textbf{primary estimand} is the biomarker-by-
...
\(\hat{\beta}_{bm:D}\) with bias-corrected sandwich variance per\textsuperscript{\citeproc{ref-wang2016geesmv}{21}}). \textbf{Primary inferential outputs} are power
...
\CSLLeftMargin{3. }%
\CSLRightInline{Huynh H, Feldt LS. Estimation of the {Box} correction for degrees of freedom from sample data in randomized block and split-plot designs. \emph{Journal of Educational Statistics}. 1976;1(1):69-82.}
...
\CSLLeftMargin{23. }%
\CSLRightInline{{Tong G, Nevins P, Ryan M, others, Taljaard M}. A review of current practice in the design and analysis of extremely small stepped-wedge cluster randomized trials. \emph{Clinical Trials}. 2025;22(1):45-56. doi:\href{https://doi.org/10.1177/17407745241276137}{10.1177/17407745241276137}}
...
\CSLLeftMargin{34. }%
\CSLRightInline{Mauchly JW. Significance test for sphericity of a normal n-variate distribution. \emph{Annals of Mathematical Statistics}. 1940;11(2):204-209.}
