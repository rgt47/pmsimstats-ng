...
#   Rscript analysis/scripts/parity/test-parity-extended-tidyverse.R --full
...
DIV_PATH <- 'analysis/scripts/parity/parity_divergences.csv'
...
report_path <- 'analysis/scripts/parity/parity_report.rds'
